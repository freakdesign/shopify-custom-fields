...
*/
(function(){if("undefined"!=typeof Shopify)if("undefined"!=typeof jQuery)if($("html.freakdesign_custom_fields").length)alert("Already loaded the tool?");else{var p=document,t=p.URL;p.documentElement.className+=" freakdesign_custom_fields";if(1<t.indexOf("myshopify.com/admin")){var a=function(){var p={no_fields:"No custom fields found",error_get_metafields:"Error getting product metafields",loaded:"Custom Field tool loaded"},s={debug:!1,author:"freakdesign",alpha:!1,omega:!1,wait:1E3,showHelp:!0,whiteLabel:!1,
lockToAlpha:!1,products:{},collections:{},linklists:{},pages:{},namespace:"custom_fields",namespace_new:"c_f",whitelist:[],key_articles:"[a]",key_collections:"[c]",key_customers:"[cu]",key_pages:"[g]",key_orders:"[o]",key_products:"[p]",marker_collection:"[_c]",marker_file:"[_f]",marker_int:"[_i]",marker_page:"[_g]",marker_product:"[_p]",marker_textarea:"[_t]",marker_linklist:"[_l]",help_file:"//freakdesign-us.s3.amazonaws.com/shopify/custom_fields/freakdesign-custom-fields-for-shopify-guide.pdf",
css:"//rawgithub.com/freakdesign/shopify-custom-fields/master/freakdesign_custom_fields.css"};return{data:function(a,c){if("undefined"===typeof c)return s[a];s[a]=c},translate:function(a){return p[a]},notice:function(a,c){c?Shopify.Flash.error(a):Shopify.Flash.notice(a)},escape_html:function(a){var c=document.createElement("div");c.appendChild(document.createTextNode(a));return c.innerHTML},unescape_html:function(a){if(void 0===a)return"";var c=document.createElement("div");c.innerHTML=a;return(a=
...
else if(d.length){var f=function(k,h){"undefined"===typeof k&&(k=0);if("undefined"===typeof h)a.notice("Type unknown",!0);else{var g=d.eq(k),e=g.attr("data-key"),r=g.val(),l="POST",m=g.attr("data-namespace"),n=g.attr("data-type"),q=!1,e={metafield:{namespace:m,key:e,value:r,value_type:n}};0===r.length&&g.attr("data-mid")&&g.attr("data-pid")?(l="DELETE",ajax_url="/admin/"+a.data("alpha")+"/"+g.attr("data-pid")+"/metafields/"+g.attr("data-mid")+".json",g.removeAttr("data-pid data-mid")):0===r.length?
q=!0:ajax_url=b.url;q?(k++,k<d.length?f(k,h):(c.attr("style","").removeClass("is-loading disabled"),a.notice("Custom fields saved"))):$.ajax({type:l,url:ajax_url,dataType:"json",data:e,success:function(b){k++;k<d.length?f(k,h):(c.attr("style","").removeClass("is-loading disabled"),a.notice("Custom fields saved"))},error:function(){a.notice("Error saving custom fields",!0);c.attr("style","").removeClass("is-loading disabled")}})}};f(0,e)}else a.notice("No fields to save",!0),c.attr("style","").removeClass("is-loading disabled")}},
...
!0);$("<a/>",{"class":"btn tooltip tooltip-bottom btn-primary",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label tooltip-right-align">Does NOT save the page</span></span>Save Custom Fields').on("click",function(b){b.preventDefault();b={t:$(this),callback:!1,url:c};a.save_custom_fields(b)});e.length&&"Save"===e.val()&&e.val("Save (without Custom Fields)");a.data("fields",[]);$.ajax({type:"GET",url:"/admin/metafields.json",dataType:"json",success:function(b){for(var h="",g=
0,e=b.metafields.length;g<e;g++){var f=b.metafields[g].namespace,l=!1;0<a.data("whitelist").length&&-1<$.inArray(f,a.data("whitelist"))&&(l=!0);var m=a.key_check(b.metafields[g].value+b.metafields[g].key);if(m.limit===a.data("alpha")||!1===m.limit)if(f===a.data("namespace")||f===a.data("namespace_new")||l){var n=b.metafields[g].key,q=a.data("fields");q.push(b.metafields[g].key);a.data("fields",q);n=a.remove_brackets(n);h+='<div class="half">';h=1<b.metafields[g].value.length?h+('<label for="product-type"><span class="tooltip tooltip-bottom" style="display:inline-block;position:relative">'+
n+'<span class="tooltip-container"><span class="tooltip-label">'+b.metafields[g].namespace+"."+b.metafields[g].key+'</span></span></span><span class="note block">'+a.remove_brackets(b.metafields[g].value)+"</span></label>"):h+('<label for="product-type">'+n+"</label>");h="textarea"==m.field?h+('<textarea data-namespace="'+f+'" name="'+b.metafields[g].key+'" placeholder="'+a.remove_brackets(b.metafields[g].key)+'" data-key="'+b.metafields[g].key+'" data-type="'+b.metafields[g].value_type+'"></textarea>'):
h+('<input data-namespace="'+f+'" data-cffield="'+m.field+'" data-cftype="'+m.type+'" name="'+b.metafields[g].key+'" placeholder="'+a.remove_brackets(n)+'" value="" data-key="'+b.metafields[g].key+'" data-type="'+b.metafields[g].value_type+'">');h+="</div>"}}b=!0;h.length||(h='<div class="box warning">'+a.translate("no_fields")+"</div>",b=!1);d.find("div.section-content").append('<div class="custom_fields_box is-product clearfix fadein"><div class="content">'+h+"</div></div>");a.data("variantPanel",
h);b&&(d.find('input[data-cftype="collection"]').each(function(){var b=$(this);b.after(a.build_select(b.attr("name"),"collection"))}),d.find('input[data-cftype="linklist"]').each(function(){}),d.find('input[data-cftype="product"]').each(function(){}),$.ajax({type:"GET",url:c,dataType:"json",success:function(b){for(var c=0,d=b.metafields.length;c<d;c++)l=!1,0<a.data("whitelist").length&&-1<$.inArray(b.metafields[c].namespace,a.data("whitelist"))&&(l=!0),(b.metafields[c].namespace===a.data("namespace")||
b.metafields[c].namespace===a.data("namespace_new")||l)&&"global"!==b.metafields[c].namespace&&"description_tag"!==b.metafields[c].key&&$('input[data-key="'+b.metafields[c].key+'"],textarea[data-key="'+b.metafields[c].key+'"]').val(b.metafields[c].value).attr({"data-mid":b.metafields[c].id,"data-pid":a.data("omega")})},error:function(b){a.notice(a.translate("error_get_metafields"),!0)}}),h=$("<a />",{"class":"btn fadein btn-primary"}).on("click",function(b){b.preventDefault();b={t:$(this),callback:!1,
url:c};a.save_custom_fields(b)}).text("Save Custom Fields"),$("#cf-summary").append(h))},error:function(b){a.notice(a.translate("error_get_metafields"),!0)}});"products"===b&&(b=$("<a />",{"class":"btn btn-slim customfield_btn tooltip tooltip-bottom tooltip-right-align fadein",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Show Custom Fields</span></span>Custom Fields').on("click",function(b){b.preventDefault();var c=$(this);$("tr.custom_fields_box").find("input").each(function(){$(this).val("")}).end().remove();
...
f=$("<td />",{colspan:"6",style:"padding:1em;border-bottom:2px solid #000"}).html(a.data("variantPanel")).append(f);b.append(f);b.find('input[data-cftype="collection"]').each(function(){var b=$(this);b.after(a.build_select(b.attr("name"),"collection"))});c.after(b);$.ajax({type:"GET",url:"/admin/variants/"+d+"/metafields.json",success:function(b){console.log(b);e.removeClass("is-loading");for(var c=$("tr.custom_fields_box.is-variant").eq(0),f=0,h=b.metafields.length;f<h;f++){var k=b.metafields[f];
c.find('input[name="'+k.key+'"]').val(k.value).attr({"data-mid":k.id,"data-pid":a.data("omega"),"data-vid":d});c.find('textarea[name="'+k.key+'"]').val(k.value).attr({"data-mid":k.id,"data-pid":a.data("omega"),"data-vid":d})}}})}),e=$("<li />"),e.append(b),$("table.variants tr.variant td:last-child ul.segmented").append(e))},build_select:function(b,c){if(b){var d=a.data("collections"),e=$("<select />",{"data-ref":b,style:"width:50%"}).change(function(a){var c=$(this);a=c.val();c=c.parent().find('input[name="'+
b+'"]').eq(0);a?c.val(a):c.val("")});if(d&&1<Object.keys(d.collections).length){for(var f='<option value="">Pick a collection</option>',k=0,h=Object.keys(d.collections).length;k<h;k++)f+='<option value="'+d.collections[k].handle+'">'+d.collections[k].title+"</option>";e.html(f);return e}a.notice("Error, invalid collection length",!0)}},type_check:function(b,c){var d=!1;c&&(b+=c);0>b.indexOf(a.data("key_products"))&&0>b.indexOf(a.data("key_pages"))&&0>b.indexOf(a.data("key_collections"))&&0>b.indexOf(a.data("key_articles"))?
d=!0:-1<b.indexOf(a.data("key_products"))&&"products"===a.data("alpha")?d=!0:-1<b.indexOf(a.data("key_articles"))&&"articles"===a.data("alpha")?d=!0:-1<b.indexOf(a.data("key_collections"))&&"custom_collections"===a.data("alpha")?d=!0:-1<b.indexOf(a.data("key_collections"))&&"smart_collections"===a.data("alpha")?d=!0:-1<b.indexOf(a.data("key_collections"))&&"collections"===a.data("alpha")&&(d=!0);return d},key_check:function(b){var c={field:"text",type:!1,limit:!1};-1<b.indexOf(a.data("marker_collection"))?
(c.field="select",c.type="collection"):-1<b.indexOf(a.data("marker_textarea"))&&(c.field="textarea",c.type="string");-1<b.indexOf(a.data("key_articles"))?c.limit="articles":-1<b.indexOf(a.data("key_collections"))?(c.limit="custom_collections","smart_collections"===a.data("alpha")&&(c.limit="smart_collections"),"collections"===a.data("alpha")&&(c.limit="collections")):-1<b.indexOf(a.data("key_customers"))?c.limit="customers":-1<b.indexOf(a.data("key_pages"))?c.limit="pages":-1<b.indexOf(a.data("key_orders"))?
c.limit="orders":-1<b.indexOf(a.data("key_products"))&&(c.limit="products");return c},load_ui:function(){if(0===$("#freakdesign_main_button").length){var b=$("<a>",{id:"freakdesign_main_button","class":"fadein"}).text("Custom Fields ON").on("click",function(b){b.preventDefault();a.data("whiteLabel")||a.fd_modal(!0,'<p><img src="//freakdesign-us.s3.amazonaws.com/shopify/custom_fields/i/modal_header.png" /></p><p>Custom Fields is "honor-ware", which means that we trust each other to be nice. As the developer of it, I\'m committed to keeping the tool something that\'s actually useful. By releasing new features and correcting possible bugs on a constant basis I can do just that, but I need your support. If you use it and intend to keep it, please sponsor its development by making a small <a target="_blank" href="http://shopify.freakdesign.com.au/#donate2">contribution</a>.</p><p>A small <a href="'+
