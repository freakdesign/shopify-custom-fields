...
function(b){b.preventDefault();var c=$(this);$("tr.custom_fields_box").find("input").each(function(){$(this).val("")}).end().remove();b=$("<tr />",{"class":"custom_fields_box is-variant"});var c=c.closest("tr"),d=c.find("a").eq(0).prop("href").split("/").pop(),g=$("<a />",{"class":"btn is-loading btn-primary","data-action":"save_custom_fields_variants"}).text("Save Variant Custom Fields").off("click").on("click",function(b){b.preventDefault();b={t:$(this),url:"/admin/variants/"+d+"/metafields.json",
