...
a.data("showHelp")&&(custom_field_panel.find(".section-summary").append('<p>Refer to the <a target="_blank" href="'+a.data("help_file")+'">help file</a> for more info.</p>'),d.find(".custom-fields-content p").eq(0).after('<p>Refer to the <a target="_blank" href="'+a.data("help_file")+'">help file</a> for more info.</p>'));"customers"===a.data("alpha")?(f=$("section#customer-notes").eq(0),custom_field_panel=d):"orders"===a.data("alpha")?(e=$("header .header-right ul").eq(1),f=$("section#order_notes").eq(0),
